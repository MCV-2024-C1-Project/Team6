...
if __name__ == '__main__':
    ...
    predict_parser.add_argument('--descriptor-type', required=False, default="Histogram-RGB-256", help='Descriptor type to be used, in the format "histogram-color-bins"')
    predict_parser.add_argument('--measure', required=False, default="HellingerKernel", help='Measure function to be used for similarity ranking')
